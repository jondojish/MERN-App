...
const Register = (props) => {
    ...
    <form onSubmit={(event) => {
      ...
      <h1 id="header_text" className="h3 mb-3 font-weight-normal">Register</h1>
      
      <input name="username" value={username} onChange={event => {setUser(event.target.value)}} type="email-username" id="inputUsername" className="form-control" placeholder="Username"
        required autoFocus />

      <input name="email" value={email} onChange={event => {setEmail(event.target.value)}}
       type="email-username" className="form-control" placeholder="Email address" required autoFocus />
      
      <input name="passwor1" value={pass1} onChange={event => {setPass1(event.target.value)}} type="password" style={{marginBbottom: '-1px'}} className="form-control"
        placeholder="Password" required autoFocus />
      
      <input name="password2" value={pass2} onChange={event => {setPass2(event.target.value)}} type="password" className="form-control" placeholder="Confirm Password"
        required />
